...
class Naver_Product(models.Model):
    ...
    delivery = models.BigIntegerField()
    ...
    img_width = models.BigIntegerField()
    img_height = models.BigIntegerField()
    three_day = models.BigIntegerField()
    six_mon = models.BigIntegerField()
